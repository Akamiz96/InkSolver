...
===============================================================================
Proyecto: Inksolver
Archivo: clasificador_manual.py
Descripcion: Clasificador simple basado en distancia Euclidiana entre vectores
             de tinta por cuadrante y los vectores promedio por dígito.
...
def clasificador_manual(csv_prototipos="csv_por_digito/promedios_por_digito.csv",
                        csv_individuales_path="csv_por_digito",
                        salida="operand_analysis/clasificacion_resultados.csv",
                        block_size=100):
    """
